                                ...
                                <div key={sizeStr} className="group bg-card border-2 border-muted rounded-2xl p-6 hover:border-primary hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 flex flex-col items-center text-center">
                                    ...
                                    <div className="w-full flex flex-col gap-2 mt-auto">
                                        <Link
                                            ...
                                            className="w-full inline-flex h-10 items-center justify-center gap-2 rounded-xl px-4 text-sm font-bold shadow-sm transition-colors bg-primary text-primary-foreground hover:bg-primary/90"
                                        >
                                            <Calendar className="w-4 h-4" />
                                            {t('makeAppointment')}
                                        </Link>
                                        <a
                                            href={`https://wa.me/32467871205?text=${encodeURIComponent(`ik ben geïnteresseerd in een tweedehands band van maat ${sizeStr}`)}`}
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="w-full inline-flex h-10 items-center justify-center gap-2 rounded-xl px-4 text-sm font-bold shadow-sm transition-colors bg-[#25D366] text-white hover:bg-[#20bd5a]"
                                        >
