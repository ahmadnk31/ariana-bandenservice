    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full h-12 rounded-md inline-flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold uppercase tracking-wider shadow transition-colors hover:bg-[#20bd5a]"
            >
